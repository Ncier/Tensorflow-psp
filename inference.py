...
ade20k_param = {'crop_size': [180, 180],
                'num_classes': 2, 
                'model': PSPNet50}
cityscapes_param = {'crop_size': [180, 180],
                    'num_classes': 2,
                    'model': PSPNet101}
...
def get_arguments():
    ...
    parser.add_argument("--img-path", type=str, default=input_dir,
...
tf.flags.DEFINE_string('mode', "cityscapes", "Mode cityscapes/ ade20k/ visualize") 
...
def main():
    ...
    # load parameters
    if FLAGS.mode == "ade20k":
        param = ade20k_param
    elif FLAGS.mode == "cityscapes":
